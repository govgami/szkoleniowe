...
public HttpXmlNbpActSpecCurrency(String currencyShortcut, ValueReader reader){
	info=HttpXmlExchangeDownloaderFactory.exchangeRateA(currencyShortcut);
...
public static HttpXmlNbpActSpecCurrency linkActCurrConn(String currencyShortcut) {
	return new HttpXmlNbpActSpecCurrency(currencyShortcut, new SAXNumericReader("Mid"));
}
}
